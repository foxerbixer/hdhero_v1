...
import { getHorror, showMoviePage } from '../../redux/ducks/movies'
...
class Horror extends Component {
  ...
  componentDidMount() {
    this.props.getHorror && this.props.getHorror()
  }
...
export default connect(mapStateToProps, { getHorror, selectMovie, showMoviePage })(withStyles(styles)(Horror))
