...
import { getMelodrama, showMoviePage } from '../../redux/ducks/movies'
...
class Melodrama extends Component {
  ...
  componentDidMount() {
    this.props.getMelodrama && this.props.getMelodrama()
  }
...
export default connect(mapStateToProps, { getMelodrama, selectMovie, showMoviePage })(withStyles(styles)(Melodrama))
