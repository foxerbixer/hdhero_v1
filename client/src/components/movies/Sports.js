...
import { getSport, showMoviePage } from '../../redux/ducks/movies'
...
class Sports extends Component {
  ...
  componentDidMount() {
    this.props.getSport && this.props.getSport()
  }
...
export default connect(mapStateToProps, { getSport, selectMovie, showMoviePage })(withStyles(styles)(Sports))
