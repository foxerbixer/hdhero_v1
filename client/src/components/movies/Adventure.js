...
import { getAdventure, showMoviePage } from '../../redux/ducks/movies'
...
class Adventure extends Component {
  ...
  componentDidMount() {
    this.props.getAdventure && this.props.getAdventure()
  }
...
export default connect(mapStateToProps, { getAdventure, selectMovie, showMoviePage })(withStyles(styles)(Adventure))
