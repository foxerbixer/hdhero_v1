...
import { getCrime, showMoviePage } from '../../redux/ducks/movies'
...
class Crime extends Component {
  ...
  componentDidMount() {
    this.props.getCrime && this.props.getCrime()
  }
...
export default connect(mapStateToProps, { getCrime, selectMovie, showMoviePage })(withStyles(styles)(Crime))
