...
import { moviesSelector, selectMovie, showMoviePage } from '../../redux/ducks/movies'
...
class DesiredList extends Component {
...
export default connect(mapStateToProps, { showMoviePage })(withStyles(styles)(DesiredList))
