...
import { getWestern, showMoviePage } from '../../redux/ducks/movies'
...
class Western extends Component {
  ...
  componentDidMount() {
    this.props.getWestern && this.props.getWestern()
  }
...
export default connect(mapStateToProps, { getWestern, selectMovie, showMoviePage })(withStyles(styles)(Western))
