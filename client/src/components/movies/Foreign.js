...
import { getForeign, showMoviePage } from '../../redux/ducks/movies'
...
class Foreign extends Component {
  ...
  componentDidMount() {
    this.props.getForeign && this.props.getForeign()
  }
...
export default connect(mapStateToProps, { getForeign, selectMovie, showMoviePage })(withStyles(styles)(Foreign))
