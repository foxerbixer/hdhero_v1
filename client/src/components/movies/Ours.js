...
import { getOurs, showMoviePage } from '../../redux/ducks/movies'
...
class Ours extends Component {
  ...
  componentDidMount() {
    this.props.getOurs && this.props.getOurs()
  }
...
export default connect(mapStateToProps, { getOurs, selectMovie, showMoviePage })(withStyles(styles)(Ours))
