...
import { getFantasy, showMoviePage } from '../../redux/ducks/movies'
...
class Fantasy extends Component {
  ...
  componentDidMount() {
    this.props.getFantasy && this.props.getFantasy()
  }
...
export default connect(mapStateToProps, { getFantasy, selectMovie, showMoviePage })(withStyles(styles)(Fantasy))
