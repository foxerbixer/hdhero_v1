...
import { getMovies, showMoviePage } from '../../redux/ducks/movies'
  ...
  render() {
    ...
    return (
      <Grid container className={classes.root} spacing={16}>
        {/* <Grid container justify='center' style={{marginBottom: 30}}><Search /></Grid> */}
        {content}
      </Grid>
    )
  }
...
export default connect(mapStateToProps, { getMovies, selectMovie, showMoviePage })(withStyles(styles)(MoviesList))
