...
import { getArt, showMoviePage } from '../../redux/ducks/movies'
...
class Art extends Component {
  ...
  componentDidMount() {
    this.props.getArt && this.props.getArt()
  }
...
export default connect(mapStateToProps, { getArt, selectMovie, showMoviePage })(withStyles(styles)(Art))
