...
import { getBiographical, showMoviePage } from '../../redux/ducks/movies'
...
class Biographical extends Component {
  ...
  componentDidMount() {
    this.props.getBiographical && this.props.getBiographical()
  }
...
export default connect(mapStateToProps, { getBiographical, selectMovie, showMoviePage })(withStyles(styles)(Biographical))
