...
import { getTravels, showMoviePage } from '../../redux/ducks/movies'
...
class Travels extends Component {
  ...
  componentDidMount() {
    this.props.getTravels && this.props.getTravels()
  }
...
export default connect(mapStateToProps, { getTravels, selectMovie, showMoviePage })(withStyles(styles)(Travels))
