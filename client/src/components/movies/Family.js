...
import { getFamily, showMoviePage } from '../../redux/ducks/movies'
...
class Family extends Component {
  ...
  componentDidMount() {
    this.props.getFamily && this.props.getFamily()
  }
...
export default connect(mapStateToProps, { getFamily, selectMovie, showMoviePage })(withStyles(styles)(Family))
