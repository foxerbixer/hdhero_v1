...
import { getDocumentary, showMoviePage } from '../../redux/ducks/movies'
...
class Documentary extends Component {
  ...
  componentDidMount() {
    this.props.getDocumentary && this.props.getDocumentary()
  }
...
export default connect(mapStateToProps, { getDocumentary, selectMovie, showMoviePage })(withStyles(styles)(Documentary))
