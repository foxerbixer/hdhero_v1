...
import { getChildish, showMoviePage } from '../../redux/ducks/movies'
...
class Childish extends Component {
  ...
  componentDidMount() {
    this.props.getChildish && this.props.getChildish()
  }
...
export default connect(mapStateToProps, { getChildish, selectMovie, showMoviePage })(withStyles(styles)(Childish))
