...
import { getTriller, showMoviePage } from '../../redux/ducks/movies'
...
class Triller extends Component {
  ...
  componentDidMount() {
    this.props.getTriller && this.props.getTriller()
  }
...
export default connect(mapStateToProps, { getTriller, selectMovie, showMoviePage })(withStyles(styles)(Triller))
