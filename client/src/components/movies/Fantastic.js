...
import { getFantastic, showMoviePage } from '../../redux/ducks/movies'
...
class Fantastic extends Component {
  ...
  componentDidMount() {
    this.props.getFantastic && this.props.getFantastic()
  }
...
export default connect(mapStateToProps, { getFantastic, selectMovie, showMoviePage })(withStyles(styles)(Fantastic))
