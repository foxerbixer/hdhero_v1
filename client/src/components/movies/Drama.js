...
import { getDrama, showMoviePage } from '../../redux/ducks/movies'
...
class Drama extends Component {
  ...
  componentDidMount() {
    this.props.getDrama && this.props.getDrama()
  }
...
export default connect(mapStateToProps, { getDrama, selectMovie, showMoviePage })(withStyles(styles)(Drama))
