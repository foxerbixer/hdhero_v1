...
import { getAction, showMoviePage } from '../../redux/ducks/movies'
...
class Action extends Component {
  ...
  componentDidMount() {
    this.props.getAction && this.props.getAction()
  }
...
export default connect(mapStateToProps, { getAction, selectMovie, showMoviePage })(withStyles(styles)(Action))
