...
import { getMusical, showMoviePage } from '../../redux/ducks/movies'
...
class Musical extends Component {
  ...
  componentDidMount() {
    this.props.getMusical && this.props.getMusical()
  }
...
export default connect(mapStateToProps, { getMusical, selectMovie, showMoviePage })(withStyles(styles)(Musical))
