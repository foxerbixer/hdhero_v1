...
import { getHistory, showMoviePage } from '../../redux/ducks/movies'
...
class History extends Component {
  ...
  componentDidMount() {
    this.props.getHistory && this.props.getHistory()
  }
...
export default connect(mapStateToProps, { getHistory, selectMovie, showMoviePage })(withStyles(styles)(History))
