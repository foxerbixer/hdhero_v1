...
import { getComedy, showMoviePage } from '../../redux/ducks/movies'
...
class Comedy extends Component {
  ...
  componentDidMount() {
    this.props.getComedy && this.props.getComedy()
  }
...
export default connect(mapStateToProps, { getComedy, selectMovie, showMoviePage })(withStyles(styles)(Comedy))
