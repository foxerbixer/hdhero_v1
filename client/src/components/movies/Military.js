...
import { getMilitary, showMoviePage } from '../../redux/ducks/movies'
...
class Military extends Component {
  ...
  componentDidMount() {
    this.props.getMilitary && this.props.getMilitary()
  }
...
export default connect(mapStateToProps, { getMilitary, selectMovie, showMoviePage })(withStyles(styles)(Military))
