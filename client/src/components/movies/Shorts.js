...
import { getShorts, showMoviePage } from '../../redux/ducks/movies'
...
class Shorts extends Component {
  ...
  componentDidMount() {
    this.props.getShorts && this.props.getShorts()
  }
...
export default connect(mapStateToProps, { getShorts, selectMovie, showMoviePage })(withStyles(styles)(Shorts))
