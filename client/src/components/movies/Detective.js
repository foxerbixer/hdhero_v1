...
import { getDetective, showMoviePage } from '../../redux/ducks/movies'
...
class Detective extends Component {
  ...
  componentDidMount() {
    this.props.getDetective && this.props.getDetective()
  }
...
export default connect(mapStateToProps, { getDetective, selectMovie, showMoviePage })(withStyles(styles)(Detective))
