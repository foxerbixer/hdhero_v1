...
import { getUkr, showMoviePage } from '../../redux/ducks/movies'
...
class Ukr extends Component {
  ...
  componentDidMount() {
    this.props.getUkr && this.props.getUkr()
  }
...
export default connect(mapStateToProps, { getUkr, selectMovie, showMoviePage })(withStyles(styles)(Ukr))
